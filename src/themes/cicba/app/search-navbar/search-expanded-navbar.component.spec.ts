...
import { SearchExpandedNavbarComponent } from '/search-expanded-navbar.component';
import { PaginationServiceStub } from '../../../../app/shared/testing/pagination-service.stub';
import { RouterTestingModule } from '@angular/router/testing';

describe('SearchExpandedNavbarComponent', () => {
  let component: SearchExpandedNavbarComponent;
  let fixture: ComponentFixture<SearchExpandedNavbarComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [SearchExpandedNavbarComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SearchExpandedNavbarComponent);
